...
We can see that the probabilty of death, increases as the patients age. Obviously A linear regression is not that appropriate of a model, but we will show how this is the case now.
...
the above logistic models predicts death as function of age in this analysis the probabilty of age is restricted to the interval \[0,1\] which is more appropiate for a binary outcome.
